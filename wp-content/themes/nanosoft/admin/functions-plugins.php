...
function nanosoft_register_requirement_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'  => 'https://demo.21lab.co/plugins.php?id=shortcodes',
			'version' => '1.0.6'
		),
		...
		array(
			...
			'source'  => 'https://demo.21lab.co/plugins.php?id=acf'
		),

		array(
			'name'   => 'WPBakery Visual Composer',
			'slug'   => 'js_composer',
			'source' => 'https://demo.21lab.co/plugins.php?id=js_composer'
		),
