...
if ( is_page_template( 'tmpl/template-fullwidth.php' ) ) {
    $row_options = (array) nanosoft_option( 'global__layout__width' );
    $row_options['width'] = intval( $row_options['width'] ) + 30 . 'px';
    $row_options['margin'] = '0 auto';

    unset( $row_options['max-width'] );

    nanosoft_define_style( '.content > .vc_row > .row-inner, .content > .vc_section > .vc_row > .row-inner,.vc_editor.compose-mode .content .vc_element .vc_row .row-inner', $row_options );
}
